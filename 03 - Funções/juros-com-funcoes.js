...
function calcularValorFinal(preco, formaPagamento){
    if (formaPagamento === 1 ){
        return 'O valor do produto é R$ ' + (preco - preco * 0.1).toFixed(2) + ' com 10% de desconto';
    } else if (formaPagamento ===  2){ 
        return 'O valor do produto é R$' + (preco - preco * 0.15).toFixed(2) + ' com 15% de desconto';
    } else if (formaPagamento === 3){
        return 'O valor do produto é R$ ' + (preco.toFixed(2)) + ' em até 2x sem juros';
    } else {
        return 'O valor do produto é R$ ' + (preco * 1.1).toFixed(2) + ' com 10% de juros';
    }
}
